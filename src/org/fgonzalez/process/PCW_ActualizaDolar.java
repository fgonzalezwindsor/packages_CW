 ...
 */
public class PCW_ActualizaDolar extends SvrProcess
{
	...
	protected String doIt() throws AdempiereSystemError
	{
		...
		if (p_Order_ID>0)
		{
			...
			DB.executeUpdate("Update T_OVNOFACTURADAMU set NEWDOLAR=" +p_Order_ID, this.get_TrxName());
