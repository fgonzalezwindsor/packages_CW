 ...
 * 
 */
public class VInOutGenTxt extends InOutGenTXT implements FormPanel, ActionListener, VetoableChangeListener
{
	...
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(VInOutGenTxt.class);
	//
