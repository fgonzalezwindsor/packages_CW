	...
	implements FormPanel, ActionListener
{
	...
	//
	private static final String s_none = "seleccione Formato a usar";	//	no format indicator
	//
	...
	private void dynInit()
	{
		...
		String sql = "SELECT Name FROM AD_ImpFormat Where AD_ImpFormat.Name like '%B2C%' ";
				//MRole.getDefault().addAccessSQL("SELECT Name FROM AD_ImpFormat", "AD_ImpFormat",
				//MRole.SQL_FULLYQUALIFIED, MRole.SQL_RO);
		//String sql2 ="SELECT Name FROM AD_ImpFormat Where AD_ImpFormat.Name like '%B2C%' ";
		try
		{
