 ...
 * 
 */
public class VInvoiceGenTxt extends InOutGenTXT implements FormPanel, ActionListener, VetoableChangeListener
{
	...
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(VInvoiceGenTxt.class);
	//
