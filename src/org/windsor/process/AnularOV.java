 ...
 */
public class AnularOV extends SvrProcess
{
	...
	protected String doIt() throws AdempiereSystemError, SQLException
	{
		...
		MOrder o = new MOrder (getCtx(), p_order, get_TrxName());
		
		
			
			int io_id = Integer.parseInt(DB.getSQLValueString(null, "Select coalesce(max(m_InOut_ID),0) from m_inout where docstatus in ('DR','IP','CO') "+
