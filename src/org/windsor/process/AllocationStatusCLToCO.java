 ...
 */
public class AllocationStatusCLToCO extends SvrProcess
{
	//private Properties 		m_ctx;	


	      
private int p_allo = 0;
	/**
	...
	protected void prepare()
	{
		...
		for (int i = 0; i < para.length; i++)
		{
			...
			if (para[i].getParameter() == null)
				...
				p_allo=para[i].getParameterAsInt()	;
	...
	protected String doIt() throws AdempiereSystemError, SQLException
	{
		...
		//	Delete Old Imported
			...
			no = DB.executeUpdate("Update C_AllocationHdr set DocStatus='CO', DocAction='VO' where C_AllocationHdr_ID="+p_allo, get_TrxName());
			log.fine("Asignaciones a estado Completo =" + no);
			
		//	commitEx();
		
		return "La Asignaciones a estado completo:"+no;		
